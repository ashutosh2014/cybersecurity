...
?>
	...
	<header class="header-section">
		...
		<div class="nav-warp">
			...
			<ul class="main-menu">
				<li id="index"><a href="./index.html">Home</span></a></li>
				<li><a href="./peoples.php">People</a></li>
				<li><a href="./projects.php">Projects</a></li>
				<li><a href="#"><span class="active123">Downloads</span></a></li>
...
function checkvalue($a,$value) {
    ...
    if( preg_match('/\bpdf\b/', $a) && ($value==1 || $value ==0))
    	return 1;
   	elseif(preg_match('/\btext\b/', $a) && ($value==2 || $value ==0))
    	return 1;
	elseif(preg_match('/\bvideo\b/', $a) && ($value==3 || $value ==0))
    	return 1;
	elseif(preg_match('/\bimage\b/', $a) && ($value==4 || $value ==0))
    	return 1;
	elseif(preg_match('/\baudio\b/', $a) && ($value==5 || $value ==0))
    	return 1;
    elseif(preg_match('/\bmsword\b/', $a) && ($value==7 || $value ==0))
    	return 1;
    else
    	return 0;
}
