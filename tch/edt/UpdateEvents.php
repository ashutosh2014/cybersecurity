			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-lg-3">
						<div class="row">
							<a href="UpdateResources.php" class="ggg00"><div class="col-12 ddd00">
								Upload Resource
							</div></a>
							<a href="#"  class="ggg00"><div class="col-12 ddd00 active001">
								Upload Events
							</div></a>
							<a href="./peoples.html"  class="ggg00"><div class="col-12 ddd00">
								Upload Resource
							</div></a>
						</div>
					</div>
					<div class="col-md-8 col-lg-9">
						...
						<div class="row">
							...
							<div class="col-sm-5">
								<input type="text" name="desc" class="title-css" required="required">
							</div>
						</div>
						<div class="row">
							<div class="col-sm-7">
