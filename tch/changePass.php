...
?>
	...
	<header class="header-section">
		...
		<div class="nav-warp">
			...
			<ul id="ul001">
				<li class="hhhhh009">Change Password</li>
				<li class="hhhhh009">
	...
	<section class="mid">
		<form method="post" enctype="multipart/form-data">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="error00" style="width: 100%;display: block;height: 20px;margin-bottom: 15px;"> 
					<?php  include('errors123.php') ?>				
					</div>
						<div class="row">
							<div class="col-sm-7">
								<div class="row cc002">
							...
							<div class="col-sm-5">
								<input type = "password" name="old" placeholder="Old Password" class="title-css" required="required">
							</div>
						</div>
						<div class="row">
							<div class="col-sm-7">
							...
							<div class="col-sm-5">
								<input type="password" name="n1" class="title-css" required="required">
							</div>
						</div>
						<div class="row">
							<div class="col-sm-7">
							...
							<div class="col-sm-5">
								<input type="password" name="n2" class="title-css" required="required">
							</div>
						</div>
						<div class="hhhh0011">
